...
public class Assignment8Part1ext extends WindowProgram {
    ...
    public static final double PAUSE_TIME = 100;
    ...
    /**
     * This method tracks the mouse cursor when it enters the window
     *
     * @param e the event to be processed
     */
    ...
    /**
     * This method tracks the mouse cursor when it exits the window
     *
     * @param e the event to be processed
     */
