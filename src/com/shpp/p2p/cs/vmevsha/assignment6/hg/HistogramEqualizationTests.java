...
import com.shpp.p2p.cs.vmevsha.assignment6.hg.teest.TeestCase;
import com.shpp.p2p.cs.vmevsha.assignment6.hg.teest.TeestRunnerPanel;
import com.shpp.p2p.cs.vmevsha.assignment6.hg.teest.TeestSuite;

public class HistogramEqualizationTests extends SimpleProgram {
    public void init() {
        TeestRunnerPanel panel = new TeestRunnerPanel(new TeestSuite("histogramFor Tests", new TeestCase() {
        ...
        }), new TeestSuite("cumulativeSumFor Tests", new TeestCase() {
            public String getName() {
                return "Result array should have proper number of entries.";
            }
        ...
        }), new TeestSuite("totalPixelsIn Tests", new TeestCase() {
            public String getName() {
